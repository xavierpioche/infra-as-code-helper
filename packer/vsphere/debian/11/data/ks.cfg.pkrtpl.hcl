...
d-i pkgsel/include string openssh-server open-vm-tools python3-apt perl console-data

# Add User to Sudoers
d-i preseed/late_command string \
    echo '${build_username} ALL=(ALL) NOPASSWD: ALL' > /target/etc/sudoers.d/${build_username} ; \
    mkdir -p /target/home/${build_username}/.ssh
    echo '${build_key}' > /target/home/${build_username}/.ssh/authorized_keys
    in-target chmod 440 /etc/sudoers.d/${build_username} ;
    in-target chmod 400 /home/${build_username}/.ssh/authorized_keys
