...
variable "ansible_password_crypted" {
  type = string
  sensitive = true
  default = ""
}
...
variable "vm_inst_os_timezone" {
   type = string
}

variable "vm_inst_ip_device" {
   type = string
}

variable "vm_inst_ip_addr" {
  type = string
}

variable "vm_inst_ip_mask" {
   type = string 
}

variable "vm_inst_ip_gw" {
   type = string 
}

variable "vm_inst_ip_dns1" {
   type = string
}

variable "vm_inst_ip_dns2" {
   type = string
}

variable "vm_inst_ip_ntp1" {
  type = string
}

variable "rhel_repository" {
  type    = string
}

variable "rh_authcommand" {
  type   = string
}
